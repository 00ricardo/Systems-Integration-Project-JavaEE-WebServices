...
public class Skill implements Serializable {
	...
	@ManyToMany()
	//@JoinTable(name = "skill_researcher", joinColumns = @JoinColumn(name = "id_skill", referencedColumnName = "ID"), inverseJoinColumns = @JoinColumn(name = "USER_ID", referencedColumnName = "ID"))
